...
1. **Identifica una creencia limitante** que tengas sobre ti mismo en el ámbito profesional. ("No soy bueno para X", "No tengo lo que se necesita para Y")

2. **Cuestiónala:** ¿Es un hecho o una interpretación? ¿Qué evidencia tienes a favor y en contra?

3. **Reescríbela:** Convierte esa creencia en una declaración de crecimiento. ("Todavía no soy bueno para X, pero puedo aprender", "Puedo desarrollar lo que se necesita para Y")
